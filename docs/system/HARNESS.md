...
|---|---|---|
| 1 hard | `_phl_times_atoms_hard` | `PHL_HARD_ATOMS` (PHLConcurrencyAtBroadmeadow, PHLAnd2ndConcurrencyAtBroadmeadow, GosfordFridayRoundsForced — **PHLRoundOnePlay removed by spec-010**) |
