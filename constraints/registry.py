...
CONSTRAINT_REGISTRY: Dict[str, ConstraintInfo] = {
    ...
    'BroadmeadowFridayCount': ConstraintInfo(
        canonical_name='BroadmeadowFridayCount',
        solver_class_names=['BroadmeadowFridayCount'],
        tester_check_methods=['_check_phl_second_grade_times'],
        tester_violation_names=['PHLAndSecondGradeTimes'],
        severity_level=1,
        atom_group='PHLAndSecondGradeTimes',
    ),
    'GosfordFridayCount': ConstraintInfo(
        canonical_name='GosfordFridayCount',
        solver_class_names=['GosfordFridayCount'],
        tester_check_methods=['_check_phl_second_grade_times'],
        tester_violation_names=['PHLAndSecondGradeTimes'],
        severity_level=1,
        atom_group='PHLAndSecondGradeTimes',
    ...
    'MaitlandFridayCount': ConstraintInfo(
        canonical_name='MaitlandFridayCount',
        solver_class_names=['MaitlandFridayCount'],
        tester_check_methods=['_check_phl_second_grade_times'],
        tester_violation_names=['PHLAndSecondGradeTimes'],
        severity_level=1,
        atom_group='PHLAndSecondGradeTimes',
