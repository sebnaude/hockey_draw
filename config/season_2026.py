...
LOCKED_PAIRINGS = []  # final-form: locked draw-pairing pins removed — only
# genuine club requirements live in FORCED_GAMES. The previous 246 week-7+
# pinned pairings (regen workaround) were intentionally dropped on this branch.
...
FORCED_GAMES = [
    ...
    # 3rd/4th Derby: not forced here (was previously covered by locked wk8 pins,
    # which have been removed on this branch — solver places these freely).
    ...
    # Norths v Wests Weekend Jun 14: 2nd-5th not forced here (was previously
    # covered by locked wk13 pins, now removed on this branch).
